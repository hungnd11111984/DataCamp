...
daily_temp_climate = daily_climate.reindex()['Temperature']
...
#7 Weekly average temperature and visibility

# Import matplotlib.pyplot as plt
import matplotlib.pyplot as plt

# Select the visibility and dry_bulb_faren columns and resample them: weekly_mean
weekly_mean = df_clean.resample('W').mean()[['visibility','dry_bulb_faren']]
...
# 10 Probability of high temperatures
